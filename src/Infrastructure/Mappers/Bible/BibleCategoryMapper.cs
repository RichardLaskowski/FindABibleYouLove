...
{
    public override BibleCategoryEntity<TType> Map(BibleCategoryContract<TType> value) => throw new NotImplementedException();
    public override BibleCategoryContract<TType> Map(BibleCategoryEntity<TType> value) => throw new NotImplementedException();
